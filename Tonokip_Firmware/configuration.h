...
long max_acceleration_units_per_sq_second = 2000; // Max acceleration in mm/s^2 for printing moves
long max_travel_acceleration_units_per_sq_second = 2000; // Max acceleration in mm/s^2 for travel moves
#endif
#ifdef EXP_ACCELERATION
float full_velocity_units = 6; // the units between minimum and G1 move feedrate
float travel_move_full_velocity_units = 6; // used for travel moves
float min_units_per_second = 20; // the minimum feedrate
...
float e_steps_per_unit = 200/(6.5*3.14159)*(43/10);
